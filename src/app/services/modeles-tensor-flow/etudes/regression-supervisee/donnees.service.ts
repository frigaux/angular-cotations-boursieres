...
import {PontDonneesCoursVagues} from './pont-donnees-cours-vagues.class';
...
export class DonneesService {
  ...
  async donneesCoursVagues(): Promise<PontDonneesCoursVagues> {
    ...
    return new Promise(resolve =>
      resolve(new PontDonneesCoursVagues(donnees))
    );
  }
}
