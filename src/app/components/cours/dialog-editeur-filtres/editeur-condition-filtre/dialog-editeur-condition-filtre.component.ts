...
@Component({
  ...
  styleUrls: ['../../../parametrage/gestion-portefeuilles/dialog-editeur-alertes/editeur-condition-alerte/dialog-editeur-condition-alerte.component.sass', './dialog-editeur-condition-filtre.component.sass']
})
