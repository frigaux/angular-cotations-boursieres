...
@Component({
  ...
  styleUrls: ['./formulaire-url-sauvegarde-restauration.component.sass', '../../../portefeuilles/gestion-portefeuilles/formulaire-creation/formulaire-creation.component.sass']
})
